...
export default function Page() {
  return (
    <main
      className={`
        min-h-screen flex items-start md:items-center justify-center
        bg-slate-900 overflow-x-hidden overflow-y-auto
        ${inter.className}
      `}
    >
      <div className="mx-auto max-w-4xl px-4 py-10 md:py-16">
        <section
          className={`
            ...
            backdrop-blur-md shadow-2xl ring-1 ring-black/10
            px-6 py-8 md:px-12 md:py-12
          `}
        >
          {/* only this div is relative now */}
          ...
          <h1
            className={`
              mt-8 text-center text-2xl md:text-3xl text-emerald-300
              drop-shadow-[0_0_8px_rgba(16,185,129,.35)]
              ${pixel.className}
            `}
          >
            AGENTS AT WORK
          ...
          <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
            <Link
              ...
              className="
                ...
                font-semibold text-emerald-950 shadow-lg shadow-emerald-500/30
            ...
            <a
              ...
              rel="noreferrer"
              className="
                rounded-xl border border-slate-700/70 bg-black/20
